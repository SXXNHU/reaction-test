...
export default function GameArena({ onBack, initialMode = 'classic' }: { onBack: () => void; initialMode?: ModeKey }) {
  const [phase, setPhase] = useState<Phase>('hangar')
  const [selectedMode, setSelectedMode] = useState<ModeKey>(initialMode)
  ...
  return (
    <main className="f1-arena-app">
      <button className="ga-back-btn" onClick={onBack} type="button">← HOME</button>
